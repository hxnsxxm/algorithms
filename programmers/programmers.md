...
|         알고리즘         |           레벨            | 문제                                                       | 푼 횟수 | 다시 풀 문제 |         풀이 날짜          | 비고                           |
|:--------------------:|:-----------------------:|:---------------------------------------------------------|:----:|:-------:|:----------------------:|:-----------------------------|
|                      | [1](./level1/level1.md) | [숫자 문자열과 영단어](./level1/숫자문자열과영단어/숫자문자열과영단어.md)           |  2   |    X    |        20240316        | 2021 카카오 채용연계형 인턴십           |
|                      | [1](./level1/level1.md) | [키패드 누르기](./level1/키패드누르기/키패드누르기.md)                     |  2   |    X    |        20240316        | 2022 KAKAO TECH INTERNSHIP   |
|                      | [1](./level1/level1.md) | [성격 유형 검사하기](./level1/성격유형검사하기/성격유형검사하기.md)              |  2   |    X    |        20240316        | 2022 KAKAO TECH INTERNSHIP   |
|         정규식          | [1](./level1/level1.md) | 신규 아이디 추천                                                |  2   |    O    |        20240316        | 2021 KAKAO BLIND RECRUITMENT |
|    날짜(LocalDate)     | [1](./level1/level1.md) | 개인정보 수집 유효기간                                             |  2   |    O    |        20240316        | 2023 KAKAO BLIND RECRUITMENT |
...
|                      | [2](./level2/level2.md) | [뒤에 있는 큰 수 찾기](./level2/뒤에있는큰수찾기/뒤에있는큰수찾기.md)            |  1   |    X    |        20240405        | 연습문제                         |
|                      | [2](./level2/level2.md) | [더 맵게](./level2/더맵게/더맵게.md)                              |  1   |    X    |        20240406        | 힙(Heap)                      |
|                      | [2](./level2/level2.md) | [방문 길이](./level2/방문길이/방문길이.md)                           |  1   |    X    |        20240407        | Summer/Winter Coding(~2018)  |
|                      | [2](./level2/level2.md) | [주식가격](./level2/주식가격/주식가격.md)                            |  1   |    O    |        20240408        | 스택/큐                         |
|                      | [2](./level2/level2.md) | [롤케이크 자르기](./level2/롤케이크자르기/롤케이크자르기.md)                  |  1   |    O    |        20240409        | 연습문제                         |
...
|                      | [2](./level2/level2.md) | [3차 프렌즈4블록](./level2/프렌즈4블록/프렌즈4블록.md)                   |  1   |    X    |        20240416        | 2018 KAKAO BLIND RECRUITMENT |
|                      | [2](./level2/level2.md) | [숫자 변환하기](./level2/숫자변환하기/숫자변환하기.md)                     |  1   |    O    |        20240417        | 연습문제                         |
|                      | [2](./level2/level2.md) | [2 x n 타일링](./level2/타일링2xn/타일링2xn.md)                   |  1   |    X    |        20240418        | 연습문제                         |
|                      | [2](./level2/level2.md) | [2개 이하로 다른 비트](./level2/몇개이하로다른비트/2개이하로다른비트.md)          |  1   |    O    |        20240429        | 월간 코드 챌린지 시즌 2               |
|                      | [2](./level2/level2.md) | [다리를 지나는 트럭](./level2/다리를지나는트럭/다리를지나는트럭.md)              |  1   |    O    |        20240430        | 스택/큐                         |
|                      | [2](./level2/level2.md) | [가장 큰 수](./level2/가장큰수/가장큰수.md)                          |  1   |    O    |        20240501        | 정렬                           |
|                      | [2](./level2/level2.md) | [소수 찾기](./level2/소수찾기/소수찾기.md)                           |  1   |    X    |        20240502        | 완전탐색                         |
|                      | [2](./level2/level2.md) | [쿼드압축 후 개수 세기](./level2/쿼드압축후개수세기/쿼드압축후개수세기.md)          |  1   |    O    |        20240503        | 월간 코드 챌린지 시즌 1               |
|                      | [2](./level2/level2.md) | [마법의 엘리베이터](./level2/마법의엘리베이터/마법의엘리베이터.md)               |  1   |    O    |        20240520        | 연습문제                         |
|                      | [2](./level2/level2.md) | [시소 짝꿍](./level2/시소짝꿍/시소짝꿍.md)                           |  1   |    O    |        20240521        | 연습문제                         |
|                      | [2](./level2/level2.md) | [호텔 대실](./level2/호텔대실/호텔대실.md)                           |  1   |    O    |        20240528        | 연습문제                         |
|                      | [2](./level2/level2.md) | [배달](./level2/배달/배달.md)                                  |  1   |    X    |        20240528        | Summer/Winter Coding(~2018)                             |
